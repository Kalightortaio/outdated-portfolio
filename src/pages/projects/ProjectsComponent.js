...
class Projects extends Component {
  render() {
    ...
    const ProjectsData = [
        ...
        {"id":"NYLq3zYqFEUWZ38L","name":"Drain Sensei","createdAt":"June 5th 2019","url":"https://github.com/Kalightortaio/Drain-Sensei","description":"A mobile app created to service both consumers and plumbing professionals with the usage of Drain Sensei devices.","languages":[{"name":"React Native","iconifyClass":"cib-react"}]},
        {"id":"5ucbFsPvxqrKwD66","name":"Shortcut","createdAt":"August 2nd 2018","url":"https://github.com/Kalightortaio/Shortcut","description":"A powershell module aimed at making navigating the Windows OS a little easier.","languages":[{"name":"Powershell","iconifyClass":"vscode-icons:file-type-powershell"}]},
        ...
        {"id":"6fC5U2MhbgwtK2LH","name":"Oryx's Paracosm (WIP)","createdAt":"February 5th 1st 2021","url":"https://github.com/Kalightortaio/Oryxs-Paracosm","description":"My current project into lower level programming and game development.","languages":[{"name":"C++","iconifyClass":"logos-c-plusplus"},{"name":"OpenGL","iconifyClass":"logos-opengl"}]},
    ]
    return (
          ...
          <Fade bottom duration={2000} distance="40px">
            <div className="projects-heading-div">
              ...
              <div className="projects-heading-text-div">
                ...
                >
                  My projects make use of a vast array of different languages and modules. Each serves as a unique challenge to  strengthen my knowledge, and expand my horizons.
                </p>
              </div>
            </div>
          </Fade>
